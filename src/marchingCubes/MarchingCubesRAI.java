...
public class MarchingCubesRAI {
	 ...
	 * @return
	 */
	public Mesh generateSurface(RandomAccessibleInterval<LabelMultisetType> input, int[] volDim, float[] voxDim,
	...
	public Mesh generateSurfaceRAI(RandomAccessibleInterval<LabelMultisetType> input, int[] volDim, float[] voxDim,
	...
	public Mesh generateSurfaceArray(RandomAccessibleInterval<LabelMultisetType> input, int[] volDim, float[] voxDim,
			boolean isExact, int level) {
		if (hasValidSurface)
			deleteSurface();
