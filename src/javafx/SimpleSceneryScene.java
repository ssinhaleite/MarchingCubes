...
public class Viewer3D
{
	...
	public Viewer3D( SceneryPanel panel )
	{
		if ( panel != null )
			this.scPanel = panel;
		else
	 ...
	 *            existing array.
	 */
	public static void updateMesh( final viewer.Mesh m, final Mesh neuron, final boolean overwriteArray )
	{
...
//			chunks.add( chunk );
			...
			for ( int i = 0; i < chunks.size(); i++ )
			{
				...
				final Future< viewer.Mesh > result = executor.submit( callable );
